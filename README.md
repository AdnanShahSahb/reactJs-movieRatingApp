...
There are total 3 pages and no.s of components

the pages are Home, Movie Detail, and 404page
...
WE ALSO DISPATCH "removeSelectedMovieOrSeries()" AS A CLEANUP FUNC SO IT DOESNT SHOW THE PREVIOUS SELECTED SPECIFIC MOVIE
